...
public class Wishlist_Nopcommerce extends BaseTest {
	...
	public void TC_01_Add_To_Wishlist(Method method) {
		...
		ExtentTestManager.getTest().log(LogStatus.INFO,
				"Add_To_Wishlist _01 - Step 03: Click to 'HDD 320GB' Radio button ");
		productPage.selectHDDButton();

		ExtentTestManager.getTest().log(LogStatus.INFO,
				"Add_To_Wishlist _01 - Step 04: Click to 'Add to Wishlist' button ");
		productPage.clickOnButtonByName(driver, "Add to wishlist");

		ExtentTestManager.getTest().log(LogStatus.INFO,
				"Add_To_Wishlist _01 - Step 05: Verify Wishlist is added success Message is displayed");
		...
		ExtentTestManager.getTest().log(LogStatus.INFO,
				"Add_To_Wishlist _01 - Step 07: Verify Product is added is displayed ");
		...
		ExtentTestManager.getTest().log(LogStatus.INFO,
				"Add_To_Wishlist _01 - Step 09: Verify Name of list product is displayed ");
	...
	public void TC_02_Add_Product_To_Cart(Method method) {
		ExtentTestManager.startTest(method.getName(), "TC_01_Register_To_System");
		ExtentTestManager.getTest().log(LogStatus.INFO,
				"Add_Product_To_Cart _02 - Step 01: Click to 'Add to Cart' Check Box ");
		wishlistPage.clickToAddToCartCheckBox();

		ExtentTestManager.getTest().log(LogStatus.INFO,
				"Add_Product_To_Cart _02 - Step 02: Click to 'Add to Cart' Butt ");
		...
		ExtentTestManager.getTest().log(LogStatus.INFO,
				"Add_Product_To_Cart _02 - Step 04:  Verify Shopping Cart have one qty ");
	...
	public void TC_03_Delete_Wishlist(Method method) {
		...
		ExtentTestManager.getTest().log(LogStatus.INFO,
				"Delete_Wishlist _03 - Step 04: Click to 'HDD 320GB' Radio button ");
		productPage.selectHDDButton();
